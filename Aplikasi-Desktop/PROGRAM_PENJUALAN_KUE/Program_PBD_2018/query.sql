...
BULK INSERT kue
FROM 'E:\PROGRAM_PENJUALAN_KUE\Program_PBD_2018\datakue.csv'
WITH
(
FIRSTROW = 2,
FIELDTERMINATOR = ';',
...
kue.Harga_kue * detail_pembelian.Jml_beli AS Jml_bayar
FROM kue INNER JOIN
...
-- Membuat prosedur simpan_penyuplaian --
...
-- Membuat prosedur simpan_pembelian --
...
ALTER PROCEDURE simpan_detail_pembelian
@Kd_beli CHAR(5),
@Kd_kue CHAR(5),
@jml_beli INT
AS
...
ALTER TRIGGER AfterDelete_DetailPembelian
ON detail_pembelian
AFTER DELETE
AS
BEGIN
