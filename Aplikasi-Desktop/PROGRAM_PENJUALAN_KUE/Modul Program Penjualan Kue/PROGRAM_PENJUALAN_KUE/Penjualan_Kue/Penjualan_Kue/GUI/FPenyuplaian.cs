...
namespace Penjualan_Kue.GUI
{
    public partial class FPenyuplaian : Form
    {
        ...
        public static FPenyuplaian ObjTransaksi;
        ...
        private void AutoNumber()
        {
            ...
            {
                hitung = Convert.ToInt64(rd[0].ToString().Substring(rd["Kd_suplai"].ToString().Length - 3, 3)) + 1;
                string joinstr = "000" + hitung;
                urut = "PE" + joinstr.Substring(joinstr.Length - 3, 3);
            }
        ...
        private void SimpanMasterPenyuplaian()
        {
            ...
            SqlConnection conn = konn.GetConn();
            {
                ...
                cmd = new SqlCommand("EXECUTE simpan_penyuplaian '" + txtKodeSuplai.Text + "','"
                    + dtpTanggalPenyuplaian.Text + "','" + txtIdSupplier.Text + "','" + txtIdKasir.Text + "'", conn);
        ...
        {
            InitializeComponent();
            // Report - Mengisi variabel ObjTransaksi dengan nilai FPnyuplaian
            ObjTransaksi = this;
        ...
        private void btnTambah_Click(object sender, EventArgs e)
        {
            ...
            SqlConnection conn = konn.GetConn();
            {
                ...
                if (txtKodeSuplai.Text.Trim() == "" || txtIdSupplier.Text.Trim() == "" ||
                    ...
                    txtJenisKue.Text.Trim() == "" || txtJumlahSuplai.Text.Trim() == "0")
                {
                ...
                {
                    conn.Open();
                    cmd = new SqlCommand("SELECT * FROM penyuplaian WHERE Kd_suplai = '" +
                        txtKodeSuplai.Text + "'", conn);
                    cmd.ExecuteNonQuery();
        ...
        private void dataGridPenyuplaian_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtJenisKue.Text = row.Cells["Jenis_kue"].Value.ToString();
        ...
        private void btnSimpan_Click(object sender, EventArgs e)
        {
            ...
            // Report - Memanggil report bukti penyuplaian
            FBuktiPenyuplaian bp = new FBuktiPenyuplaian();
            bp.Show();
            Awal();
        }
        ...
        private void btnCariKue_Click(object sender, EventArgs e)
        {
            ...
            txtJenisKue.Text = cariKue.ambilJenisKue;
